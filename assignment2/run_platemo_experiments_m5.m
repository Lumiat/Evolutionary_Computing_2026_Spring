%% run_platemo_experiments_m5_modified.m
% Run five PlatEMO algorithms on six multi-objective benchmark problems.
% This script only runs the M = 5 experiments.
%
...
fprintf('\nAll M=5 runs finished. MAT files are under: %s\n', ...
